...
//        [SerializeField] private KeyCode _bulletKey = KeyCode.Mouse0;
//        [SerializeField] private KeyCode _laserKey = KeyCode.Space;
...
namespace AsteroidsClone
{
    ...
    public sealed class GameConfig : ScriptableObject
    {
        [field: SerializeField] public float ScreenWidth { get; private set; } = 20f;
